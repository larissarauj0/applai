  ...
  return (
    <div id={id}>
      <div className="flex items-center justify-center h-64 text-[#f0f6ff]">
        {stepper.flow.switch({
          step1: () => <p>Seus dados</p>,
          step2: () => <p>A vaga</p>,
          step3: () => <p>O resultado</p>,
        })}
      </div>
      ...
      <div className="flex justify-between items-center">
        {stepper.state.isLast ? (
          <button
            className="bg-[#1a2a4a] text-[#f0f6ff] rounded-xl p-2 cursor-pointer border border-[#21355c] hover:bg-[#4a9eff] hover:text-[#1a2a4a] transition duration-300 flex"
          ...
          <>
            <button
              className="bg-[#1a2a4a] text-[#f0f6ff] rounded-xl p-2 cursor-pointer border border-[#21355c] hover:bg-[#4a9eff] hover:text-[#1a2a4a] transition duration-300"
